...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyF3 Or _
       KeyCode = vbKeyF And Shift = vbCtrlMask Then
        frmSearch.Show
    End If
End Sub
...
Private Sub Form_Load()
    ...
    Caption = "Remote DCE " & App.Major & "." & App.Minor & "." & App.Revision & " - " & dSession.InstanceName
...
Private Sub lstSyncEvents_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
    If Button = vbRightButton Then
        If Not lstSyncEvents.SelectedItem Is Nothing Then
            Me.PopupMenu mnuPopup, , , , mnuPopupEdit
        End If
    End If
End Sub
...
Private Sub lstSyncEvents_DblClick()
    ...
    If Not li Is Nothing Then
        If Left(TreeKey, 4) = "FLD-" Then ' Folder
            ...
            Set code = New frmEditor
            With code
                .Caption = dSession.InstanceName & ":/" & FolderPath(fld) & " - " & li.Text
        ...
        ElseIf Left(TreeKey, 4) = "FRM-" Then ' Form
            ...
            Set code = New frmEditor
            With code
                .Caption = dSession.InstanceName & "://Forms/" & frm.Name & " - " & li.Text
...
Private Sub lstAsyncEvents_DblClick()
    ...
    If Not li Is Nothing Then
        ...
        Set code = New frmEditor
        With code
            .Caption = dSession.InstanceName & ":/" & FolderPath(fld) & " - AsyncEvent " & li.Text
...
Private Sub lstDocuments_DblClick()
    ...
    If Not li Is Nothing Then
        ...
        If LCase(fld.Form.Guid) = LCase("F89ECD42FAFF48FDA229E4D5C5F433ED") Then
            Set dom = fld.Search("code", "doc_id=" & id)
            With code
                .Caption = dSession.InstanceName & ":/" & FolderPath(fld) & " - " & li.Text
                .CodeMax1.Text = dom.documentElement.childNodes(0).getAttribute("code")
                .CodeType = 3
                Set .Folder = fld
                .DocId = id
                .Field = "code"
        ...
        ElseIf LCase(fld.Form.Guid) = LCase("EAC99A4211204E1D8EEFEB8273174AC4") Then
            Set dom = fld.Search("scriptbeforerender", "doc_id=" & id)
            With code
                .Caption = dSession.InstanceName & ":/" & FolderPath(fld) & " - " & li.Text
                .CodeMax1.Text = dom.documentElement.childNodes(0).getAttribute("scriptbeforerender")
                .CodeType = 3
                Set .Folder = fld
                .DocId = id
        ...
        ElseIf fld.Form.Properties.Exists("DCE_CodeColumn") Then
            ...
            Set dom = fld.Search(sCodeCol, "doc_id=" & id)
            With code
                .Caption = dSession.InstanceName & ":/" & FolderPath(fld) & " - " & li.Text
                .CodeMax1.Text = dom.documentElement.childNodes(0).getAttribute(LCase(sCodeCol))
                .CodeType = 3
                Set .Folder = fld
                .DocId = id
                .Field = sCodeCol
...
Private Sub mnuPopupEdit_Click()
    If frmMain.ActiveControl.Name = "lstSyncEvents" Then
        lstSyncEvents_DblClick
    ElseIf frmMain.ActiveControl.Name = "lstDocuments" Then
        lstDocuments_DblClick
    ElseIf frmMain.ActiveControl.Name = "lstAsyncEvents" Then
...
Private Sub mnuPopupHist_Click()
    ...
    If frmMain.ActiveControl.Name = "lstSyncEvents" Then
        ...
        If Not li Is Nothing Then
            If Left(TreeKey, 4) = "FLD-" Then ' Folder
                ...
                With hist
                    .Caption = "History of " & dSession.InstanceName & ":/" & FolderPath(fld) & " - " & li.Text
                    .CodeType = 1
                    Set .Folder = fld
                    .EventKey = li.Key
                    .Show vbModal
            ...
            ElseIf Left(TreeKey, 4) = "FRM-" Then ' Form
                ...
                Set hist = New frmHistory
                With hist
                    .Caption = "History of " & dSession.InstanceName & "://Forms/" & frm.Name & " - " & li.Text
                    .CodeType = 2
                    Set .dForm = frm
                    .EventKey = li.Key
                    .Show vbModal
    ...
    ElseIf frmMain.ActiveControl.Name = "lstAsyncEvents" Then
        ...
        If Not li Is Nothing Then
            ...
            Set hist = New frmHistory
            With hist
                .Caption = "History of " & dSession.InstanceName & ":/" & FolderPath(fld) & " - AsyncEvent " & li.Text
                .CodeType = 4
                Set .Folder = fld
                .EventKey = li.Key
                .Show vbModal
            ...
            Else
                ...
                If bHasCode Then
                    ...
                    For i = 0 To UBound(arr)
                        ...
                        'TODO: descomentar cuando se implemente Field.Properties en .NET
                        'If oFie.Properties.Exists("DCE_ListWidth") Then
                        '    sWidth = oFie.Properties("DCE_ListWidth").Value
                        'End If
                        
                        If sWidth = "" Then sWidth = "2500"
